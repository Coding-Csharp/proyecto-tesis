...
namespace ProyectoTesis.Models
{
    public partial class TesisContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.Id).HasName("pk_admin_id");
                ...
                entity.HasOne(d => d.Specialty).WithMany(p => p.Admins)
                    ...
                    .HasConstraintName("fk_admins_specialties_id");
            });

            modelBuilder.Entity<AdminCredential>(entity =>
            {
                entity.HasKey(e => e.AdminsId).HasName("pk_admin_credential_employees_id");
                ...
                entity.HasOne(d => d.Admin).WithOne(p => p.AdminCredential)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_admins_credentials_employees_id");
            });
            ...
            modelBuilder.Entity<Assign>(entity =>
            {
                ...
                entity.HasOne(d => d.Admin).WithMany(p => p.Assigns)
                    .HasForeignKey(d => d.AdminsId)
                    .HasConstraintName("fk_assigns_admins_id");
            ...
            modelBuilder.Entity<Assist>(entity =>
            {
                ...
                entity.HasOne(d => d.Admin).WithMany(p => p.Assists)
                    .HasForeignKey(d => d.AdminsId)
                    .HasConstraintName("fk_assists_admins_id");
